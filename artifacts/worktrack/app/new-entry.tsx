...
export default function NewEntryScreen() {
  const { projects, addManualEntry } = useApp();
  ...
  const handleSave = () => {
    ...
    if (durationSecs <= 0 || !selectedProject) return;
    ...
    addManualEntry({
      ...
      description,
      startTime: now - durationSecs * 1000,
      endTime: now,
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={[styles.title, { color: theme.text }]}>Manual Entry</Text>
        ...
        {CATEGORIES.map((cat) => (
          <Pressable
            ...
            style={[
              ...
              {
                backgroundColor:
                  selectedCategory === cat ? Colors.primary : theme.surfaceSecondary,
